class ApiConfig {
  ...
  // Auth service
  static const String baseUrlAuth = 'http://10.0.2.2/api';
  ...
  // Post Service
  static const String baseUrlPost = 'http://10.0.2.2/api';
  ...
  //Comment Service
  static const String baseUrlComment = 'http://10.0.2.2/api';
  ...
  //Report Service
  static const String baseUrlReport = 'http://10.0.2.2/api';
  static const String getReportEndpoint ='/report';

  //Rewards Service
  static const String baseUrlRewards = 'http://10.0.2.2/api';
  static const String getRewardsEndpoint ='/rewards/user/points';

  //Vote Service
  static const String baseUrlVote = 'http://10.0.2.2/api';
  static const String patchVoteEndpoint ='/vote';

  //search service
  static const String baseUrlSearch = 'http://10.0.2.2/api';
